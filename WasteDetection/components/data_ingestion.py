...
class DataIngestion:
    ...
    def download_waste_data(self) -> str:
        ...
        try:
            ...
            logging.info(f'Downloaded data from {dataset_url} to {zip_file_path} ')
    ...
    def extract_zip_file(self, zip_file_path:str) -> str:
        ...
        try:
            ...
            logging.info(f'Extracted zip file {zip_file_path} to {feature_store_path}')
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            zip_file_path = self.download_waste_data()
