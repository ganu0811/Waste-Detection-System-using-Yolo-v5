...
class TrainingPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            logging.info('Entered the start_data_ingestion method of Training Pipeline class')
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        logging.info('Entered the start_data-validation method of Training Pipeline class')
        ...
        try:
            ...
            logging.info('Performed the data validation config')
